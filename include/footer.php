	...
	<div class="container">
		<div class="row" style="background: #2E2E2E;padding: 25px 0">
			...
			<div class="col-xs-12 col-sm-5 wapper1">
				...
				<span><a href="<?php echo  isset($fb) ? $fb : '' ?>" target="_blank"><img src="image/icon/fb.svg" alt="" style="width:40px"></a></span>
			</div>
	...
	<footer>
		<div class="container">
			<div class="row">
				...
				<div class="div-footer">Copyright 2018 · by <a href="admin/index.php" target="_blank">3T</a> All rights reserved</div>
			</div>
		</div>
	</footer>